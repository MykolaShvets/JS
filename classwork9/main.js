...
for (const simpson of simpsons) {
    ...
    div.style.padding = '15px';  //стилізація для того щоб текст був хоч трохи читабильним.
}
...
for (const simpson of simpsons) {
    ...
    div1.append(name, surname, age, info);
    ...
    div1.style.padding = '15px';   //стилізація для того щоб текст був хоч трохи читабильним.
}
...
for (const course of coursesArray) {
    ...
    block.style.padding = '15px';   //стилізація для того щоб текст був хоч трохи читабильним.
